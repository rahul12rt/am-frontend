...
const Banner = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative h-screen overflow-hidden bg-cover bg-center bg-no-repeat max-[768px]:bg-top max-[768px]:bg-contain max-[768px]:mt-[80px] max-[768px]:h-[calc(100vh-80px)]"
      style={{ backgroundImage: 'url("/images/hero_image.jpg")' }}
    >
      <div className="container h-full">
        <div className="h-full flex flex-col justify-end items-start py-16">
          {/* Title */}
          <h1 className="text-[5.6rem] max-[768px]:text-[4rem] font-[family-name:var(--font-ppeditorialnewitalic)] leading-[1]">
